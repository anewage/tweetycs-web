...
def self_training(X_train, y_train, pipeline, inputFile,  outputFile, parameterOut):
    run_model_self(X_train, y_train, pipeline,inputFile,outputFile, parameterOut)
...
#self_training(X, y, pipeline, 'dataCombined.csv',  'CombinedTaggedTweets.csv', 'user_category' )
